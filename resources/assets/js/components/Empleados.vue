                     ...
                     <tr>
                      <tr  v-for="objeto in ArrayDatos" :key="objeto.id">
                            ...
                            <td> 
                                ...
                                <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" @click="eliminarEmp(objeto)">
        ...
        <div class="modal-dialog modal-primary modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                        <div class="form-group row">
                            ...
                            <div class="col-md-5">
                                <input type="text" v-model="nombre"  id="nombre" name="nombre" class="form-control" placeholder="Nombre del empleado">
                                <span class="help-block">(*) Ingrese el nombre</span>
                            </div>
                             <label class="col-md-1 form-control-label" for="text-input">Apellido</label>
                            <div class="col-md-5">
                                <input type="text"  v-model="apellido" id="apellido"  name="apellido" class="form-control" placeholder="Apellido del empleado">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-5">
                                <input type="text"  v-model="cedula"  id="cedula" name="cedula" class="form-control" placeholder="Cedula del empleado">
                                <span class="help-block">(*) Ingrese la cedula</span>
                            </div>
                             <label class="col-md-1 form-control-label" for="text-input">Email</label>
                            <div class="col-md-5">
                                <input type="text"  v-model="email"  id="email" name="email" class="form-control" placeholder="Email del empleado">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-5">
                                <input type="text"  v-model="tel"  id="telefono" name="telefono" class="form-control" placeholder="Telefono del empleado">
                                <span class="help-block">(*) Ingrese el telefono</span>
                            </div>
                             <label class="col-md-1 form-control-label" for="text-input">Celular</label>
                             <div class="col-md-5">
                                <input type="text"  v-model="cel"  id="celular" name="celular" class="form-control" placeholder="Celular del empleado">
                ...
                <div class="modal-footer">
                    ...
                    <button v-show="accion==0" type="button" @click="regEmp" class="btn btn-primary">Guardar</button>
                    <button v-show="accion" type="button" @click="actEmp" class="btn btn-primary">actualizar</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
    ...
    <div class="modal fade" id="modalEliminar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-danger" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Estas seguro de eliminar el empleado?</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                    <button type="button" @click="eliminarEmp" class="btn btn-danger">Eliminar</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
            ...
            listEmp:function(){
                ...
                var url="/empleados"
                 axios.get (url).then(function(response){
                    ...
                    me.ArrayDatos = respuesta.empleados;
                })
